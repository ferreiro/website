...
function generateEmailTemplate(name, email, message, subscribed, source) {
    ...
    html += '<style>body { background:#ffffff; border:15px solid #f4f4f4; }</style>';
    html += '<style>.content { margin:20px; }</style>';
    ...
    html += '<style>.header{background:#8a8a8a;}.header p{color:#ffffff;margin:0;}.header .columns{padding-bottom:0;}.header .container{background:#8a8a8a;padding-top:16px;padding-bottom:16px;}.header .container td{padding-top:16px;padding-bottom:16px;}</style>';
    html += '</head>';
    html += '<body>';
